...
function ManageCollection() {
  ...
  if (!collection) {
    return (
      <div className="flex flex-col items-center gap-4 py-24 text-center">
        <p className="text-sm text-muted-foreground">That collection doesn&apos;t exist anymore.</p>
        <Link to="/portal/library" className="text-sm text-primary underline">
  ...
  return (
    <div className="mx-auto max-w-2xl">
      <AdminPageHeader
        title={collection.title}
        description={`${collection.images.length} photo${collection.images.length === 1 ? "" : "s"}`}
      />
      ...
      <div className="space-y-6">
          ...
          <CardContent className="space-y-3 p-5">
            ...
            <form onSubmit={submitCollection} className="space-y-3">
              <PhotoPick label="Choose a different cover" onFiles={pickCover} fallbackToCamera>
                <span className="relative mx-auto block aspect-[3/4] w-32 overflow-hidden rounded-md border border-border bg-muted/40">
                  <img
        ...
        <Card>
          <CardContent className="space-y-3 p-5">
            ...
            <form onSubmit={submitNewImage} className="space-y-3">
        ...
        <section>
          ...
          <div className="mt-4 space-y-3">
            ...
            {collection.images.length === 0 && (
              <p className="text-sm text-muted-foreground">No photos yet — add one above.</p>
            )}
          </div>
        </section>
      </div>
