...
import { ChevronLeft, Folder, Images, Lock, Pencil, Send, Sparkles } from "lucide-react";
  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-5 pb-24 pt-6">
      ...
      <p className="mx-auto mt-3 max-w-md text-center text-sm leading-relaxed text-foreground/65">
        Five galleries, yours to name. Fill each one with the pictures you love most,
        turn them into puzzles, and — only if you'd like to — send one to Pictaria to
        be considered for the community collection.
      </p>
      ...
      <div className="mt-10 rounded-3xl border border-accent/25 bg-white/60 p-5 text-center backdrop-blur">
        <Sparkles className="mx-auto h-5 w-5 text-accent" strokeWidth={1.5} />
        ...
        <div className="mt-4 flex flex-col items-center gap-2">
          ...
          >
            <Images className="h-4 w-4" strokeWidth={1.5} /> Make a storybook
          </Link>
        </div>
      </div>
    </main>
