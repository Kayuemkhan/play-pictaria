...
export function BottomBackButton() {
  ...
  return (
    <button
      ...
      onClick={goBack}
      aria-label="Back"
      className="pointer-events-auto fixed bottom-4 left-4 z-50 grid h-10 w-10 place-items-center text-accent/80 transition-transform hover:scale-105 active:scale-95"
    >
